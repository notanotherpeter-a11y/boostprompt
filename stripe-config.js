...
(function() {
    ...
    const PRODUCTS = {
        ...
        geo_starter_kit: { priceId: 'price_1T6oiuAqx5KYvfYDStow9nvd', name: 'GEO Starter Kit: Get Your Business Cited by AI', amount: 39 },
        ai_proof_seo: { priceId: 'price_1T6oivAqx5KYvfYDEaJmAPHz', name: 'AI-Proof Your SEO: 2026 Survival Guide', amount: 29 },
        voice_commerce: { priceId: 'price_1T6oiwAqx5KYvfYDosqrtT2Z', name: 'Voice Commerce Prompts Pack', amount: 19 },
        digital_pr: { priceId: 'price_1T6oixAqx5KYvfYDqnCXn9yb', name: 'Digital PR for AI Citations', amount: 39 }
    };
